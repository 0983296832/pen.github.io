...
export default function Featured({ featuredId, featuredName, featuredPrice, featuredImage }) {
    return (
                        <article className="sneaker" key={featuredId}>
                            ...
                            <Link to={`/product/${featuredId}` } className="button-light"> Add to cart <BiRightArrowAlt/></Link>
                        </article>
    )
}
