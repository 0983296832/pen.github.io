...
export default function Productcart() {
    const  {product,addToCart,cartItem,amount}  = useGlobleContext()
    const { id } = useParams();
    const [ productItem, setProductItem ] = useState(product.find((item) => item.productId === parseInt(id) ));
        ...
        <main className="pl-main pbd-grid">
            <div className="phome">
                ...
                <div className="psneaker">
                    <div className="psneaker__figure">
                    </div>
                    <div>
                        <img src={productItem.productImage} alt="" className="psneaker__img pshows" color="#A29596" />
                        <img src={productItem.productImage} alt="" className="psneaker__img" color="#111111" />
                    </div>
                    <div className="psneaker__colors">
                        <span className="psneaker__color psneaker__colors-one pactive" primary="#A29596" color="#A29596" />
                        <span className="psneaker__color psneaker__colors-two " primary="#111111" color="#111111" />
                    </div>
                </div>
                {/* ===== IFORMACION ===== */}
                <div className="pinfo">
                ...
                <div className="pdata">
                    ...
                    <p className="pdata__description">Combinan la malla transpirable sin costuras para <br /> un estilo tradicional.</p>
                </div>
                {/* ===== ACTIONS ===== */}
                ...
                <div className="ppreci">
                    ...
                    <a href="#" className="ppreci__button" onClick={ () =>addToCart(productItem) }>ADD TO CART</a>
                </div>
                </div>
            </div>
        </main>
